...
%TCIDATA{LastRevised=Friday, June 12, 2015 09:48:38}
...
\title{Documentation: MODEL\_DKWv\_option}
...
\\
&=&H_{0}+\int_{t}^{t+\tau }\left\{ 
\begin{array}{c}
\left[ \left( 1+\rho \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) ^{2}+\left( \sqrt{1-\rho ^{2}}\rho _{v}^{\pi }\sigma _{v}\left(
\kappa _{v}\right) ^{-1}\right) ^{2}\right]  \\ 
-2\left[ \left( 1+\rho \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) \rho \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}+\left( \sqrt{1-\rho ^{2}}\rho _{v}^{\pi }\sigma _{v}\left( \kappa
_{v}\right) ^{-1}\right) ^{2}\right] e^{-\kappa _{v}\left( t+\tau -s\right) }
\\ 
+\left[ \left( \rho \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) ^{2}+\left( \sqrt{1-\rho ^{2}}\rho _{v}^{\pi }\sigma _{v}\left(
\kappa _{v}\right) ^{-1}\right) ^{2}\right] e^{-2\kappa _{v}\left( t+\tau
-s\right) }%
\end{array}%
\right\} E_{t}\left[ v_{s}\right] ds \\
&=&H_{0}+\int_{t}^{t+\tau }\left\{ 
\begin{array}{c}
\left[ 1+2\rho \left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) +\left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) ^{2}\right]  \\ 
-2\left[ \rho +\left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) \right] \left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa
_{v}\right) ^{-1}\right) e^{-\kappa _{v}\left( t+\tau -s\right) } \\ 
+\left[ \left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) ^{2}\right] e^{-2\kappa _{v}\left( t+\tau -s\right) }%
\end{array}%
\right\} \left\{ \mu _{v}+e^{-\kappa _{v}\left( s-t\right) }\left( v_{t}-\mu
_{v}\right) \right\} ds \\
&\equiv &H_{0}+\mu _{v}H_{1}+H_{2}\left( v_{t}-\mu _{v}\right)  \\
&=&\left( H_{0}+\mu _{v}\left( H_{1}-H_{2}\right) \right) +H_{2}v_{t} \\
...
and%
\begin{eqnarray*}
H_{0} &\equiv &\int_{t}^{t+\tau }\left( \widehat{\sigma }_{q}-\Sigma
^{\prime }e^{-\mathcal{K}^{\prime }\left( t+\tau -s\right) }\left( \mathcal{K%
}^{\prime }\right) ^{-1}\rho _{x}^{\pi }\right) ^{\prime }\left( \widehat{%
\sigma }_{q}-\Sigma ^{\prime }e^{-\mathcal{K}^{\prime }\left( t+\tau
-s\right) }\left( \mathcal{K}^{\prime }\right) ^{-1}\rho _{x}^{\pi }\right)
...
\sigma }_{q}^{\prime }\Sigma ^{\prime }\left[ \int_{t}^{t+\tau }e^{-\mathcal{%
K}^{\prime }\left( t+\tau -s\right) }ds\right] \left( \mathcal{K}^{\prime
}\right) ^{-1}\rho _{x}^{\pi }+\rho _{x}^{\pi \prime }\left( \mathcal{K}%
\right) ^{-1}\Omega _{\tau }^{x}\left( \mathcal{K}^{\prime }\right)
^{-1}\rho _{x}^{\pi }
\end{eqnarray*}%
\begin{eqnarray*}
H_{1} &\equiv &\int_{t}^{t+\tau }\left\{ 
\begin{array}{c}
\left[ 1+2\rho \left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) +\left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) ^{2}\right]  \\ 
...
\end{array}%
\right\} ds \\
&=&\left[ 1+2\rho \left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa
_{v}\right) ^{-1}\right) +\left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa
_{v}\right) ^{-1}\right) ^{2}\right] \tau  \\
&&-2\left[ \rho +\left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) \right] \left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa
_{v}\right) ^{-1}\right) \left( \kappa _{v}\right) ^{-1}\left( 1-\exp \left(
-\kappa _{v}\tau \right) \right)  \\
&&+\left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right) ^{-1}\right)
^{2}\left( 2\kappa _{v}\right) ^{-1}\left( 1-\exp \left( -2\kappa _{v}\tau
\right) \right) 
\end{eqnarray*}%
\begin{eqnarray*}
H_{2} &\equiv &\int_{t}^{t+\tau }\left\{ 
\begin{array}{c}
\left[ 1+2\rho \left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) +\left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) ^{2}\right]  \\ 
...
^{-1}\right) ^{2}\right] e^{-2\kappa _{v}\left( t+\tau -s\right) }%
\end{array}%
\right\} e^{-\kappa _{v}\left( s-t\right) }ds \\
&=&e^{-\kappa _{v}\tau }\int_{t}^{t+\tau }\left\{ 
\begin{array}{c}
\left[ 1+2\rho \left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) +\left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) ^{2}\right]  \\ 
...
^{-1}\right) ^{2}\right] e^{-2\kappa _{v}\left( t+\tau -s\right) }%
\end{array}%
\right\} e^{\kappa _{v}\left( t+\tau -s\right) }ds \\
&=&e^{-\kappa _{v}\tau }\left\{ 
\begin{array}{c}
\left[ 1+2\rho \left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) +\left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) ^{2}\right] \left( \kappa _{v}\right) ^{-1}\left( \exp \left(
\kappa _{v}\tau \right) -1\right)  \\ 
-2\left[ \rho +\left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) \right] \left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa
_{v}\right) ^{-1}\right) \tau  \\ 
+\left[ \left( \rho _{v}^{\pi }\sigma _{v}\left( \kappa _{v}\right)
^{-1}\right) ^{2}\right] \left( \kappa _{v}\right) ^{-1}\left( 1-\exp \left(
-\kappa _{v}\tau \right) \right) 
\end{array}%
\right\} 
\end{eqnarray*}%
...
\mu -\rho _{v}^{\pi }\left( \kappa _{v}\right) ^{-1}\left( 1-\exp \left(
-\kappa _{v}\tau \right) \right) \mu _{v}\right] \\
&&+\frac{1}{2\tau }\left( H_{0}+\mu _{v}\left( H_{1}-H_{2}\right) \right) \\
&=&\left( \rho _{0}^{\pi }+\rho _{x}^{\pi \prime }\mu +\rho _{v}^{\pi }\mu
_{v}\right) -\widetilde{b}_{I}^{\prime }\mu -c_{I}\mu _{v}+\frac{1}{2\tau }%
\left( H_{0}+\mu _{v}H_{1}\right) \\
\widetilde{b}_{I}^{\prime } &=&\frac{1}{\tau }\rho _{x}^{\pi \prime }\left( 
\mathcal{K}\right) ^{-1}\left( I-e^{-\mathcal{K}\tau }\right) \\
\widetilde{c}_{I} &=&\frac{1}{\tau }\rho _{v}^{\pi }\left( \kappa
_{v}\right) ^{-1}\left( 1-\exp \left( -\kappa _{v}\tau \right) \right) +%
...
Future yield forecast. At time $t$, forecast $y_{t+h,\tau }^{N}$%
\begin{eqnarray*}
&&E_{t}\left[ y_{t+h,\tau }^{i}\right] \\
&=&a_{\tau }^{i}+b_{\tau }^{i\prime }E_{t}\left[ x_{t+h}\right] +c_{\tau
}^{i}E_{t}\left[ v_{t+h}\right] \\
&=&a_{\tau }^{i}+b_{\tau }^{i\prime }\left[ \mu +\exp \left( -\mathcal{K}%
h\right) \left( x_{t}-\mu \right) \right] \\
&&+c_{\tau }^{i}\left[ \mu _{v}+\exp \left( -\kappa _{v}h\right) \left(
