...
%TCIDATA{LastRevised=Wednesday, May 27, 2015 11:29:13}
...
_{v,t}^{N}dW_{v,t}-\Lambda _{\bot ,t}^{N}dW_{\bot ,t}-\Lambda _{\delta
,t}^{N}dW_{\delta ,t}
\end{equation}%
where the nominal short rate is%
\begin{equation}
r_{t}^{N}=\rho _{0}^{N}+\rho _{x}^{N\prime }x_{t}+\rho _{v}^{N}v_{t}+\rho
_{\delta }^{N}\delta _{t}+\rho _{s}^{N}s_{t}
\end{equation}%
...
\begin{equation}
\pi _{t}=\rho _{0}^{\pi }+\rho _{x}^{\pi \prime }x_{t}+\rho _{v}^{\pi
}v_{t}+\rho _{\delta }^{\pi }\delta _{t}+\rho _{s}^{\pi }s_{t}
\end{equation}
...
ds_{t} &=&\left( r_{t}^{N}-\delta _{t}-\frac{1}{2}\sigma _{s}^{2}+\sigma
_{s}\Lambda _{\delta ,t}^{N}\right) dt+\sigma _{s}dW_{\delta ,t} \\
&\equiv &\left( \phi _{0}+\phi _{x}^{\prime }x_{t}+\phi _{v}v_{t}+\phi
...
\right] \\
&\equiv &\exp \left( A_{\tau }^{oil}+B_{\tau }^{oil\prime }x_{t}+C_{\tau
}^{oil}v_{t}+D_{\tau }^{oil}\delta _{t}+E_{\tau }^{oil}s_{t}\right)
\end{eqnarray*}%
where%
\begin{eqnarray*}
\dot{A}_{\tau }^{oil} &=&\left( \mathcal{K}^{\ast }\mu ^{\ast }\right)
^{\prime }B_{\tau }^{oil}+\left( \kappa _{v}^{\ast }\mu _{v}^{\ast }\right)
C_{\tau }^{oil}+\left( \kappa _{\delta }^{\ast }\mu _{\delta }^{\ast
}\right) D_{\tau }^{oil}+\phi _{0}^{\ast }E_{\tau }^{oil} \\
...
\dot{C}_{\tau }^{oil} &=&-\kappa _{v}^{\ast }C_{\tau }^{oil}+\frac{1}{2}%
\sigma _{v}^{2}\left( C_{\tau }^{oil}\right) ^{2}+\phi _{v}^{\ast }E_{\tau
}^{oil} \\
...
A_{0}^{oil}=B_{0}^{oil}=C_{0}^{oil}=D_{0}^{oil}=0$ and $E_{0}^{oil}=1$.

For simplicity, we assume%
\begin{equation}
\rho _{v}^{N}=0
\end{equation}%
which implies $\phi _{v}^{\ast }=\phi _{v}=0$.
...
\end{pmatrix}%
\mathcal{B} \\
\overset{\cdot }{\mathcal{C}} &=&-\kappa _{v}^{\ast }\mathcal{C}+\frac{1}{2}%
\sigma _{v}^{2}\mathcal{C}^{2}
\end{eqnarray*}
...
_{q}+v_{t}\right) -\sigma _{q}^{\prime }\Lambda _{x,t}^{N}-\sqrt{v_{t}}%
\Lambda _{\bot ,t}^{N}\right] dt+\sigma _{q}^{\prime }dW_{x,t}+\sqrt{v_{t}}%
dW_{\bot ,t} \\
&\equiv &-r_{t}^{R}dt-\Lambda _{x,t}^{R\prime }dW_{x,t}-\Lambda
_{v,t}^{R}dW_{v,t}-\Lambda _{\bot ,t}^{R}dW_{\bot ,t}-\Lambda _{\delta
,t}^{R}dW_{\delta ,t}
\end{eqnarray*}%
where 
\begin{eqnarray*}
r_{t}^{R} &=&r_{t}^{N}-\left[ \pi _{t}+\frac{1}{2}\left( \sigma _{q}^{\prime
}\sigma _{q}+v_{t}\right) \right] +\sigma _{q}^{\prime }\Lambda _{x,t}^{N}+%
\sqrt{v_{t}}\Lambda _{\bot ,t}^{N} \\
&=&r_{t}^{N}-\left[ \pi _{t}+\frac{1}{2}\left( \sigma _{q}^{\prime }\sigma
_{q}+v_{t}\right) \right] +\sigma _{q}^{\prime }\left( \lambda
_{0,x}^{N}+\lambda _{x}^{N\prime }x_{t}\right) +\gamma _{v}^{\bot }v_{t} \\
&\equiv &\rho _{0}^{R}+\rho _{x}^{R\prime }x_{t}+\rho _{v}^{R}v_{t}+\rho
_{\delta }^{R}\delta _{t}+\rho _{s}^{R}s_{t} \\
...
_{q}^{\prime }\sigma _{q}+\lambda _{0,x}^{\prime }\sigma _{q} \\
\rho _{x}^{R} &=&\rho _{x}^{N}-\rho _{x}^{\pi }+\lambda _{x}^{N\prime
}\sigma _{q} \\
\rho _{v}^{R} &=&\rho _{v}^{N}-\rho _{v}^{\pi }+\gamma _{v}^{\bot }-\frac{1}{%
2} \\
\rho _{\delta }^{R} &=&\rho _{\delta }^{N}-\rho _{\delta }^{\pi }\text{ and }%
...
\left( -\kappa _{v}T_{1}\right) -\exp \left( -\kappa _{v}T_{2}\right)
\right)  \\
...
+\left( D_{\tau }^{N}\sigma _{\delta }+E_{\tau }^{N}\sigma _{s}\right)
dW_{\delta ,t}\right]
\end{eqnarray*}%
...
\sqrt{v_{t}}dt. \\
d\tilde{W}_{\delta ,t} &=&dW_{\delta ,t}^{\ast }-\left( \sigma _{\delta
}D_{\tau }^{N}+\sigma _{s}E_{\tau }^{N}\right) dt
\end{eqnarray*}
...
}x_{t}+\rho _{v}^{\pi \ast }v_{t}+\rho _{\delta }^{\pi \ast }v_{t}\right)
...
&=&\kappa _{\delta }^{\ast }\left( \mu _{\delta }^{\ast }-\delta _{t}\right)
dt+\sigma _{\delta }\left( d\tilde{W}_{\delta ,t}+\left( \sigma _{\delta
}D_{\tau }^{N}+\sigma _{s}E_{\tau }^{N}\right) dt\right)  \\
&=&\left( \kappa _{\delta }^{\ast }\mu _{\delta }^{\ast }+\sigma _{\delta
}\left( \sigma _{\delta }D_{\tau }^{N}+\sigma _{s}E_{\tau }^{N}\right)
-\kappa _{\delta }^{\ast }\delta _{t}\right) dt+\sigma _{\delta }d\tilde{W}%
_{\delta ,t} \\
&\equiv &\tilde{\kappa}_{\delta }\left( \tilde{\mu}_{\delta }-\delta
_{t}\right) dt+\sigma _{\delta }d\tilde{W}_{\delta ,t}
\end{eqnarray*}%
\begin{eqnarray*}
dx_{t} &=&\left[ \mathcal{K}^{\ast }\left( \mu ^{\ast }-x_{t}\right) \right]
...
\begin{eqnarray*}
E_{t}^{\mathbb{\tilde{P}}}\left( v_{s}\right)  &=&\tilde{\mu}_{v}+\exp
\left( -\tilde{\kappa}_{v}\left( s-t\right) \right) \left( v_{t}-\tilde{\mu}%
_{v}\right)  \\
\frac{1}{\tau }E_{t}^{\mathbb{\tilde{P}}}\left[ \int_{t}^{t+\tau }v_{s}ds%
\right]  &=&\tilde{\mu}_{v}+\widetilde{W}_{0,\tau }^{v}\left( v_{t}-\tilde{%
\mu}_{v}\right) \equiv \tilde{a}_{\tau }^{v}+\tilde{b}_{\tau }^{v}v_{t}
\end{eqnarray*}%
where 
\begin{equation*}
...
and%
\begin{eqnarray*}
\Omega _{t-\Delta t}^{\delta s} &=&\sigma _{\delta }\sigma _{s}E_{t-\Delta t}
\left[ \int_{t-\Delta t}^{t}e^{\kappa _{\delta }\left( u-t\right)
