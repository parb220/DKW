...
pvarLU=[      0.8604           1.e-4  10;   % KAPPA(1,1) 
              ...
              -0.3621          -10    10;   % rho1_L(1)
              -0.1987          -10    10;   % rho1_L(2)
              0.1671          -10    10;   %  rho1_L(3)
              0.9650          -10    10;   %  rhoL_L
              0.1278          -10    10;   % lambda0_L
...
% load '.\results\pvar_DKWv_option_9015.mat';
% pvar=[pvar;0.2211;0.0042;-0.3621;-0.1987;0.1671;0.9650;0.1278;-0.0867];
...
while jcount < 1000
  ...
  [pvar,logL,exitflag]=fminsearch(@logL_DKWlv_o,pvar,OPTIONS,paras_vec,pidx,Nfac,Dt, ...              
    y_vec,MATgrid,ytips_vec,TIPSgrid,p_vec,bcf_vec,bcfLT_vec,horLT, ...
    notmissing_tips,notmissing_p,notmissing_bcf,notmissing_bcfLT, ...
    IE_options,MATgrid_options,STRIKEgrid_options,notmissing_options);

  save pvar_DKWlv_o pvar;
