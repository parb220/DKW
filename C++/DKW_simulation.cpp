...
int main(int argc, char **argv)
{
	...
	while(1)
	{
		int c = getopt_long(argc, argv, "p:b:r:n:N:T:P:I:w:W:S:L:l:e:E:M:", long_options, &option_index); 
		if (c == -1)
			break; 
		switch(c)
		{
	...
	{
		int period = 100, max_period = 64*period;
                slave_computing(period, max_period, nInitial, simulation_model, mode, MaxOptimizationIterations, MaxPerturbationIterations, PerturbationScale);
	}
}
